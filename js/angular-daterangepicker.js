(function() {
  ...
  picker.directive('dateRangePicker', ['$compile', '$timeout', '$parse', '$q', '$injector', 'dateRangePickerConfig', function($compile, $timeout, $parse, $q, $injector, dateRangePickerConfig) {
    return {
      require: 'ngModel',
      restrict: 'A',
      scope: {
      ...
      link: function($scope, element, attrs, modelCtrl) {
        ...
        return $q.when(_config).then(_doLink);
      }
    };
  }]);
